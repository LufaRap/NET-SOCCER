<?php
   ...
   $result = $mysqli->query("SELECT jornada FROM `view_jornadas` GROUP BY jornada");
   ...
   if ($result->num_rows > 0){
        ...
        while ($row = $result->fetch_array(MYSQLI_ASSOC)) {
            $combobit .="<option  value='".$row["jornada"]."'> Fecha &nbsp".$row["jornada"]."</option>";
        }
    }
    else
    {
